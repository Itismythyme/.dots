...
(let* ((bg "#f5f5f5")
      (err "#222222")
      (err-container "#a05656")
      (on-background "#444444")
      (on-err "#ffffff")
      (on-err-container "#ededed")
      (on-primary "#ffffff")
      ...
      (primary "#555555")
      (primary-container "#c69696")
      (secondary "#666666")
      (secondary-container "#d2acac")
      (shadow "#ffffff")
      (surface "#f5f5f5")
      ...
      (tertiary "#333333")
      (tertiary-container "#af6a6a")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#333333")
      (on-success "#ffffff")
      (success-container "#af6a6a")
      (on-success-container "#131313")
      ;; Map fixed colors to regular colors
      (primary-fixed "#555555")
      (primary-fixed-dim "#c69696")
      (secondary-fixed "#666666")
      (secondary-fixed-dim "#d2acac")
      (tertiary-fixed "#333333")
      (tertiary-fixed-dim "#af6a6a")
      (on-primary-fixed "#ffffff")
      (on-primary-fixed-variant "#262626")
      (on-secondary-fixed "#ffffff")
      (on-secondary-fixed-variant "#262626")
      (on-tertiary-fixed "#ffffff")
      (on-tertiary-fixed-variant "#131313")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#444444")
      (inverse-primary "#555555")
